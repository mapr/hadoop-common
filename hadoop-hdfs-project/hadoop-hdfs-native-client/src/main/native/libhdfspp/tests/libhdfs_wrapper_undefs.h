...
#undef hdfsFileAces
#undef hdfsConnectAsUid
#undef hdfsPwrite
#undef hdfsSetRpcTimeout
#undef hdfsGetNameContainerSizeBytes
#undef hdfsOpenFile2
#undef hdfsCreateDirectory2
#undef hdfsExists2
#undef hdfsSetThreads
#undef hdfsGetPathFromFid2
#undef hdfsGetPathFromFidStr
#undef hdfsGetVolumeName
#undef hdfsSetXattr
#undef hdfsGetXattr
#undef hdfsSetTicketAndKeyFile
#undef hdfsSetAces
#undef hdfsGetAces
#undef hdfsDeleteAces