...
#define hdfsFileAces libhdfs_hdfsFileAces
#define hdfsConnectAsUid libhdfs_hdfsConnectAsUid
#define hdfsPwrite libhdfs_hdfsPwrite
#define hdfsSetRpcTimeout libhdfs_hdfsSetRpcTimeout
#define hdfsGetNameContainerSizeBytes libhdfs_hdfsGetNameContainerSizeBytes
#define hdfsOpenFile2 libhdfs_hdfsOpenFile2
#define hdfsCreateDirectory2 libhdfs_hdfsCreateDirectory2
#define hdfsExists2 libhdfs_hdfsExists2
#define hdfsSetThreads libhdfs_hdfsSetThreads
#define hdfsGetPathFromFid2 libhdfs_hdfsGetPathFromFid2
#define hdfsGetPathFromFidStr libhdfs_hdfsGetPathFromFidStr
#define hdfsGetVolumeName libhdfs_hdfsGetVolumeName
#define hdfsSetXattr libhdfs_hdfsSetXattr
#define hdfsGetXattr libhdfs_hdfsGetXattr
#define hdfsSetTicketAndKeyFile libhdfs_hdfsSetTicketAndKeyFile
#define hdfsSetAces libhdfs_hdfsSetAces
#define hdfsGetAces libhdfs_hdfsGetAces
#define hdfsDeleteAces libhdfs_hdfsDeleteAces
