...
#define hdfsFileAces libhdfspp_hdfsFileAces
#define hdfsConnectAsUid libhdfspp_hdfsConnectAsUid
#define hdfsPwrite libhdfspp_hdfsPwrite
#define hdfsSetRpcTimeout libhdfspp_hdfsSetRpcTimeout
#define hdfsGetNameContainerSizeBytes libhdfspp_hdfsGetNameContainerSizeBytes
#define hdfsOpenFile2 libhdfspp_hdfsOpenFile2
#define hdfsCreateDirectory2 libhdfspp_hdfsCreateDirectory2
#define hdfsExists2 libhdfspp_hdfsExists2
#define hdfsSetThreads libhdfspp_hdfsSetThreads
#define hdfsGetPathFromFid2 libhdfspp_hdfsGetPathFromFid2
#define hdfsGetPathFromFidStr libhdfspp_hdfsGetPathFromFidStr
#define hdfsGetVolumeName libhdfspp_hdfsGetVolumeName
#define hdfsSetXattr libhdfspp_hdfsSetXattr
#define hdfsGetXattr libhdfspp_hdfsGetXattr
#define hdfsSetTicketAndKeyFile libhdfspp_hdfsSetTicketAndKeyFile
#define hdfsSetAces libhdfspp_hdfsSetAces
#define hdfsGetAces libhdfspp_hdfsGetAces
#define hdfsDeleteAces libhdfspp_hdfsDeleteAces
