...
public class TaskTrackerStatus implements Writable {
  ...
  List<String> labels = new ArrayList<String>(); //create an empty list
  ...
  /* MapR addition. Status sent by TT's hearbeat */
  public TaskTrackerStatus(String trackerName, String host, 
                           int httpPort, List<TaskStatus> taskReports, 
                           int failures, int maxMapTasks,
                           int maxReduceTasks, int prefetchMapSlots) {
    this.trackerName = trackerName;
    this.host = host;
    this.httpPort = httpPort;
    ...
    this.healthStatus = new TaskTrackerHealthStatus();
    this.recoveryHB = false;
    this.prefetchMapSlots = prefetchMapSlots;
    this.ephemeralSlots = 0;
  }
  ...
  /* MapR additions */ 
  public void setRecoveryHB() {
    this.recoveryHB = true;
  }

  public boolean isRecoveryHB() {
    return recoveryHB;
  }
  
  public int getPrefetchMapSlots() { 
    return prefetchMapSlots;
  }
  
  public int getEphemeralSlots() { 
    return ephemeralSlots;
  }
  
  public void setEphemeralSlots(int ephemeralSlots) { 
    this.ephemeralSlots = ephemeralSlots;
  }
  ...
  public int getAvailableMapSlots() {
    int slots = getMaxMapSlots() - countOccupiedMapSlots();
  ...
  public int getAvailableReduceSlots() {
    int slots = getMaxReduceSlots() - countOccupiedReduceSlots();
    return (slots > 0) ? slots: 0;
  }
  ...
  /** node labels only in memory need not be serialized 
   *  TODO: synchronize??
   */
...
///////////////////////////////////////////
  ...
  public void write(DataOutput out) throws IOException {
    ...
    /* MapR additions */
    out.writeBoolean(recoveryHB);
    out.writeInt(prefetchMapSlots);
    out.writeInt(ephemeralSlots);
    shuffleRootFid.writeFields(out);
  }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    /* MapR additions */
    this.recoveryHB = in.readBoolean();
    this.prefetchMapSlots = in.readInt();
    this.ephemeralSlots = in.readInt();
    this.shuffleRootFid.readFields(in);
  }
}
