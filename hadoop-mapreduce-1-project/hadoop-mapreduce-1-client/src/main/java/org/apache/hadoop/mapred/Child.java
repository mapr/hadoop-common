...
class Child {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    String userTicketFile = 
      System.getenv().get(UserGroupInformation.USER_TICKET_FILE_LOCATION);
    if ( LOG.isDebugEnabled() ) {
      LOG.debug("Ticket File Location is: " + userTicketFile);
    }
