...
import org.apache.hadoop.mapred.TaskCompletionEventList;
...
public class Job extends JobContext {  
   ...
   * @throws IOException
   */
  public TaskCompletionEventList getTaskCompletionEventList(int startFrom)
  throws IOException
  {
    ensureState(JobState.RUNNING);
    return info.getTaskCompletionEventList(startFrom);
  }
  ...
  public void setJobSetupCleanupNeeded(boolean needed) {
    ensureState(JobState.DEFINE);
    conf.setJobSetupCleanupNeeded(needed);
  }  
