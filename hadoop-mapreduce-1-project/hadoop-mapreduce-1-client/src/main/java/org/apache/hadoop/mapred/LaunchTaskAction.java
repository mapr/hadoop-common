...
class LaunchTaskAction extends TaskTrackerAction {
  private Task task;
  private boolean useEphemeralSlot = false;

  public LaunchTaskAction() {
    super(ActionType.LAUNCH_TASK);
    this.useEphemeralSlot = false;
  }
  
  public LaunchTaskAction(ActionType type) {
    super(type);
    this.useEphemeralSlot = false;
  }
  ...
  public void setEphemeral() {
    this.useEphemeralSlot = true;
  }

  public boolean isEphemeral() {
    return this.useEphemeralSlot;
  }
  ...
  public void write(DataOutput out) throws IOException {
    ...
    task.write(out);
    out.writeBoolean(this.useEphemeralSlot);
  }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    task.readFields(in);
    this.useEphemeralSlot = in.readBoolean();
  }
}
