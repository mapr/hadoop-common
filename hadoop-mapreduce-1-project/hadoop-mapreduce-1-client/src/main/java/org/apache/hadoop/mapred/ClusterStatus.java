...
public class ClusterStatus implements Writable {
  ...
  private int totalMapPrefetchSlots;
  ...
  ClusterStatus(int trackers, int blacklists, long ttExpiryInterval, 
      int maps, int reduces, int maxMaps, int maxReduces, 
      JobTracker.State state, int numDecommissionedNodes, int totalPrefetchedMapTasks) {
  this(trackers, blacklists, ttExpiryInterval, maps, reduces, 
  maxMaps, maxReduces, state, numDecommissionedNodes, 
  UNINITIALIZED_MEMORY_VALUE, UNINITIALIZED_MEMORY_VALUE, totalPrefetchedMapTasks);
}
  ...
  ClusterStatus(int trackers, int blacklists, long ttExpiryInterval, 
    ...
    this(trackers, blacklists, ttExpiryInterval, 
      maps, reduces, maxMaps, maxReduces, 
      state, numDecommissionedNodes,
      used_memory, max_memory, 0);
  }
  
  ClusterStatus(int trackers, int blacklists, long ttExpiryInterval, 
      int maps, int reduces, int maxMaps, int maxReduces, 
      JobTracker.State state, int numDecommissionedNodes,
      long used_memory, long max_memory, int maxPrefetchMapTasks) {
    ...
    this.totalMapPrefetchSlots = maxPrefetchMapTasks;
  }
  ...
  ClusterStatus(Collection<String> activeTrackers, 
      Collection<String> blacklistedTrackers, long ttExpiryInterval,
      int maps, int reduces, int maxMaps, int maxReduces, 
      JobTracker.State state, int numDecommissionNodes, int totalPrefetchedMaps) {
  this(activeTrackers.size(), blacklistedTrackers.size(), ttExpiryInterval, 
  maps, reduces, maxMaps, maxReduces, state, numDecommissionNodes, 
  Runtime.getRuntime().totalMemory(), Runtime.getRuntime().maxMemory(), totalPrefetchedMaps);
  this.activeTrackers = activeTrackers;
  this.blacklistedTrackers = blacklistedTrackers;
  }
  ...
  public int getMaxPrefetchMapTasks() {
    return totalMapPrefetchSlots;
  }
  ...
  public void write(DataOutput out) throws IOException {
    ...
    out.writeInt(totalMapPrefetchSlots);
  }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    totalMapPrefetchSlots = in.readInt();
  }
}
