  ...
  public void doUpdates(MetricsContext unused) {
    ...
    synchronized (this) {
	  ...
	  if (AMAZON_EMR.equals(System.getProperty("mapr.cloud.environment"))) { 
		  metricsRecord.setMetric("TotalLoad", 100);
		  metricsRecord.setMetric("CapacityTotalGB", 50);
		  metricsRecord.setMetric("UnderReplicatedBlocks", 0);
		  metricsRecord.setMetric("CapacityRemainingGB", 30);
		  metricsRecord.setMetric("PendingDeletionBlocks", 0);
		  metricsRecord.setMetric("PendingReplicationBlocks", 0);
		  metricsRecord.setMetric("CorruptBlocks", 0);
		  metricsRecord.setMetric("CapacityUsedGB", 0);
		  metricsRecord.setMetric("numLiveDataNodes", 1 + numTrackers);
		  metricsRecord.setMetric("numDeadDataNodes", numTrackersDecommissioned + 1);
		  metricsRecord.setMetric("numLiveDataNodes", 4);
		  metricsRecord.setMetric("numDeadDataNodes", 4);
		  metricsRecord.setMetric("MissingBlocks", 0);
	  }
