...
import org.apache.hadoop.security.scram.ScramMessages.ServerFinalMessage;
 ...
 * handler for integration with a credential manager.
 *
  ...
  public byte[] evaluateResponse(byte[] response) throws SaslException {
    try {
      switch (state) {
        ...
        default:
          throw new AuthenticationException("Unexpected challenge in Sasl server state " + state);
      }
