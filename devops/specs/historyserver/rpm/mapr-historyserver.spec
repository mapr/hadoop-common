...
summary:     Apache Hadoop Historyserver distribution included in HPE DataFabric Software Ecosystem Pack
...
%description
Apache Hadoop Historyserver distribution included in HPE DataFabric Software Ecosystem Pack
...
if [ "$1" = "0" ]; then
    ...
    sudo su -c "__INSTALL_3DIGIT__/bin/mapred --daemon stop historyserver" -s /bin/sh $daemon_user
    rm -f __PREFIX__/conf/conf.d/warden.historyserver.conf
fi
