...
summary:     Apache Hadoop Timelineserver v2 distribution included in HPE DataFabric Software Ecosystem Pack
license:     Hewlett Packard Enterprise, CopyRight
Vendor:      Hewlett Packard Enterprise
name:        mapr-timelineserver
...
%description
Apache Hadoop Timelineserver v2 distribution included in HPE DataFabric Software Ecosystem Pack
...
if [ "$1" = "0" ]; then
    ...
    sudo su -c "__INSTALL_3DIGIT__/bin/yarn --daemon stop timelinereader" -s /bin/sh $daemon_user
    rm -f __PREFIX__/conf/conf.d/warden.timelineserver.conf
fi
:
