...
summary:     Apache Hadoop Timelineserver v1 distribution included in HPE DataFabric Software Ecosystem Pack
license:     Hewlett Packard Enterprise, CopyRight
Vendor:      Hewlett Packard Enterprise
name:        mapr-timelineserverv1
...
conflicts:   mapr-timelineserver
AutoReqProv: no


%description
Apache Hadoop Timelineserver v1 distribution included in HPE DataFabric Software Ecosystem Pack
...
if [ "$1" = "0" ]; then
    ...
    sudo su -c "__INSTALL_3DIGIT__/bin/yarn --daemon stop timelineserver" -s /bin/sh $daemon_user
    rm -f __PREFIX__/conf/conf.d/warden.timelineserverv1.conf
fi
:
