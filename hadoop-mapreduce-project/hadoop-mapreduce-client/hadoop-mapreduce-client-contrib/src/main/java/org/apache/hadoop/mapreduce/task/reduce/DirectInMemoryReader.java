...
public class DirectInMemoryReader<K,V> extends Reader<K, V> {
  ...
  public DirectInMemoryReader(DirectShuffleMergeManagerImpl<K,V> merger, TaskAttemptID taskAttemptId,
