...
public interface MRJobConfig {
  ...
  public static final String DEFAULT_MR_AM_COMMAND_OPTS = "-Xmx1024m --add-opens java.base/java.lang=ALL-UNNAMED " +
      "-XX:+UseParallelGC";
   ...
   */
  public static final String MR_AM_WEBAPP_PORT_RANGE = 
    MR_AM_PREFIX + "webapp.port-range";
  ...
  public static final int DEFAULT_MR_AM_MAX_ATTEMPTS = 3;
