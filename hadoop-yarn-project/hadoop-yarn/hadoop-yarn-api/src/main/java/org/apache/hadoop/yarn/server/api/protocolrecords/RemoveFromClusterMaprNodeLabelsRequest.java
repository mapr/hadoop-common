...
@Public
@Evolving
public abstract class RemoveFromClusterMaprNodeLabelsRequest {

  public static RemoveFromClusterMaprNodeLabelsRequest newInstance(
      String labels) {
    RemoveFromClusterMaprNodeLabelsRequest request =
        Records.newRecord(RemoveFromClusterMaprNodeLabelsRequest.class);
