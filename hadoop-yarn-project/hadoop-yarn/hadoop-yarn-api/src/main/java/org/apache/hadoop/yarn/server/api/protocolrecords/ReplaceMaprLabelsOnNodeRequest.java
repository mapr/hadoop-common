...
@Public
@Evolving
public abstract class ReplaceMaprLabelsOnNodeRequest {

  public static ReplaceMaprLabelsOnNodeRequest newInstance(
      String labels) {
    ReplaceMaprLabelsOnNodeRequest request =
        Records.newRecord(ReplaceMaprLabelsOnNodeRequest.class);
