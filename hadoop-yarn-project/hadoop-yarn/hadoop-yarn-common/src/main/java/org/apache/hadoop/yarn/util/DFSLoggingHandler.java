...
public abstract class DFSLoggingHandler {
     ...
     *
     * @param stderrFile name of the file to which stdout will be redirected
     ...
     *
     * @param relativeContainerLogDir path of the specific container directory to write to
