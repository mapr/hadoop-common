...
public class JQueryUI extends HtmlBlock {
  ...
  protected void render(Block html) {
    html.link(root_url("static/jquery/themes-1.9.1/base/jquery-ui.css"))
        .link(root_url("static/dt-1.11.3/css/jquery.dataTables.css"))
        .link(root_url("static/dt-1.11.3/css/jui-dt.css"))
        .link(root_url("static/dt-1.11.3/css/custom_datatable.css"))
        .script(root_url("static/jquery/jquery-3.6.0.min.js"))
        .script(root_url("static/jquery/jquery-ui-1.13.2.custom.min.js"))
        .script(root_url("static/dt-1.11.3/js/jquery.dataTables.min.js"))
