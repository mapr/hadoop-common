...
import org.apache.hadoop.yarn.proto.YarnServerResourceManagerServiceProtos.RemoveFromClusterMaprNodeLabelsResponseProto;
...
import org.apache.hadoop.yarn.proto.YarnServerResourceManagerServiceProtos.ReplaceMaprLabelsOnNodeRequestProto;
import org.apache.hadoop.yarn.proto.YarnServerResourceManagerServiceProtos.ReplaceMaprLabelsOnNodeResponseProto;
...
public class ResourceManagerAdministrationProtocolPBServiceImpl implements ResourceManagerAdministrationProtocolPB {
  ...
  @Override
  public AddToClusterMaprNodeLabelsResponseProto addToClusterMaprNodeLabels(RpcController controller, AddToClusterMaprNodeLabelsRequestProto proto)
      throws ServiceException {
    AddToClusterMaprNodeLabelsRequestPBImpl request =
        new AddToClusterMaprNodeLabelsRequestPBImpl(proto);
    try {
      AddToClusterMaprNodeLabelsResponse response =
          real.addToClusterMaprNodeLabels(request);
      return ((AddToClusterMaprNodeLabelsResponsePBImpl) response).getProto();
    } catch (YarnException e) {
      throw new ServiceException(e);
    } catch (IOException e) {
      throw new ServiceException(e);
  ...
  @Override
  public RemoveFromClusterMaprNodeLabelsResponseProto removeFromClusterMaprNodeLabels(RpcController controller,
      RemoveFromClusterMaprNodeLabelsRequestProto proto) throws ServiceException {
    RemoveFromClusterMaprNodeLabelsRequestPBImpl request =
        new RemoveFromClusterMaprNodeLabelsRequestPBImpl(proto);
    try {
      RemoveFromClusterMaprNodeLabelsResponse response =
          real.removeFromClusterMaprNodeLabels(request);
      return ((RemoveFromClusterMaprNodeLabelsResponsePBImpl) response).getProto();
    } catch (YarnException e) {
      throw new ServiceException(e);
    } catch (IOException e) {
      throw new ServiceException(e);
  ...
  @Override
  public ReplaceMaprLabelsOnNodeResponseProto replaceMaprLabelsOnNodes(RpcController controller, ReplaceMaprLabelsOnNodeRequestProto proto)
      throws ServiceException {
    ReplaceMaprLabelsOnNodeRequestPBImpl request = new ReplaceMaprLabelsOnNodeRequestPBImpl(proto);
    try {
      ReplaceMaprLabelsOnNodeResponse response = real.replaceMaprLabelsOnNode(request);
      return ((ReplaceMaprLabelsOnNodeResponsePBImpl) response).getProto();
  ...
  public RefreshClusterNodeLabelsResponseProto refreshClusterNodeLabels(
    ...
    try {
      RefreshClusterNodeLabelsResponse response = real.refreshClusterNodeLabels(request);
