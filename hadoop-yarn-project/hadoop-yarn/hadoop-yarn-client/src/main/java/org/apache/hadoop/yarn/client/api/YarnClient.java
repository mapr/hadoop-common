...
public abstract class YarnClient extends AbstractService {
   ...
   *
   * @param applicationId
   *  application on which enabling additional DEBUG level
   * @throws YarnException
   * @throws IOException
   */
  public abstract void addDebugApp(String applicationId)
      throws YarnException, IOException;
   ...
   *
   * @param applicationId
   *  application on which disabling additional DEBUG level
   * @throws YarnException
   * @throws IOException
   */
  public abstract void removeDebugApp(String applicationId)
      throws YarnException, IOException;
   ...
   * @throws IOException
   */
  public abstract Set<String> getDebugApps() throws YarnException, IOException;
   ...
   * @throws IOException
   */
  public abstract void addDebugQueue(String queueName)
      throws YarnException, IOException;
   ...
   *
   * @param queueName
   *  queue on which disabling additional DEBUG level
   * @throws YarnException
   * @throws IOException
   */
  public abstract void removeDebugQueue(String queueName)
      throws YarnException, IOException;
   ...
   * @throws IOException
   */
  public abstract Set<String> getDebugQueues() throws YarnException, IOException;
}
