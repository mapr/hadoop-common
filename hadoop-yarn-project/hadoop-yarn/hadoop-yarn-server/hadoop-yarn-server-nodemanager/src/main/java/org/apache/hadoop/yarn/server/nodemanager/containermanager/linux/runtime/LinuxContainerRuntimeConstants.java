...
public final class LinuxContainerRuntimeConstants {
  ...
  public static final Attribute<Path> EXT_TOKENS_PATH = Attribute
            .attribute(Path.class, "ext_tokens_path");
  public static final Attribute<String> EXT_TOKENS_ENV_VAR = Attribute
          .attribute(String.class, "ext_tokens_env_var");
