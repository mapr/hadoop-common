 ...
 new ClusterMetricsInfo(this.rm);
    ...
    thead().$class("ui-widget-header").
      tr().
        ...
        th().$class("ui-state-default").__("Disks Used").__().
        th().$class("ui-state-default").__("Disks Total").__().
        th().$class("ui-state-default").__("Disks Reserved").__().
    ...
    tbody().$class("ui-widget-content").
      tr().
        ...
        td(String.valueOf(clusterMetrics.getAllocatedDisks())).
        td(String.valueOf(clusterMetrics.getTotalDisks())).
        td(String.valueOf(clusterMetrics.getReservedDisks())).
