  ...
  static class QueueInfoBlock extends HtmlBlock {
    ...
    @Override public void render(Block html) {
      info("\'" + sinfo.getQueueName() + "\' Queue Status").
        ...
        __("Minimum Queue Memory Capacity:" , Integer.toString(sinfo.getMinQueueMemoryCapacity())).
        __("Maximum Queue Memory Capacity:" , Integer.toString(sinfo.getMaxQueueMemoryCapacity())).
        ...
        __("Queue Label:", StringEscapeUtils.escapeHtml(sinfo.getLabel())).
        __("Queue Label Policy:", StringEscapeUtils.escapeHtml(sinfo.getLabelPolicy()));
