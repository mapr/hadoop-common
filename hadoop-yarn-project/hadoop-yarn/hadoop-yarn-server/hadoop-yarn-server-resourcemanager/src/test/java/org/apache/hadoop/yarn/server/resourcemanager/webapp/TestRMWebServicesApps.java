...
public class TestRMWebServicesApps extends JerseyTestBase {
  ...
  public void verifyAppsXML(NodeList nodes, RMApp app) throws JSONException,
     ...
     for (int i = 0; i < nodes.getLength(); i++) {
      ...
      verifyAppInfoGeneric(app,
          ...
          WebServicesTestUtils.getXmlFloat(element, "preemptedDisks"),
  ...
  public void verifyAppInfo(JSONObject info, RMApp app) throws JSONException,
    ...
    verifyAppInfoGeneric(app, info.getString("id"), info.getString("user"),
        ...
        info.getInt("allocatedMB"), info.getInt("allocatedVCores"), info.getDouble("allocatedDisks"),
        info.getInt("runningContainers"), 
        info.getInt("preemptedResourceMB"),
        info.getInt("preemptedResourceVCores"),
        info.getDouble("preemptedDisks"),
  ...
  public void verifyAppInfoGeneric(RMApp app, String id, String user,
      ...
      int allocatedMB, int allocatedVCores, double allocatedDisks, int numContainers,
      int preemptedResourceMB, int preemptedResourceVCores, double preemptedDisks,
    ...
    assertEquals("allocatedDisks doesn't match", 0.0, allocatedDisks, 0.01);
    ...
    assertEquals("preemptedDisks doesn't match", app
        .getRMAppMetrics().getResourcePreempted().getDisks(),
        preemptedDisks, 0.01);
